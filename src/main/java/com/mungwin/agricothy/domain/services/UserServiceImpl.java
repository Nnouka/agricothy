...
import com.mungwin.agricothy.domain.repositories.RoleRepository;
import com.mungwin.agricothy.domain.repositories.UserRepository;
import com.mungwin.agricothy.exceptions.ApiException;
import com.mungwin.agricothy.exceptions.ErrorCodes;
import com.mungwin.agricothy.facades.AuthFacade;
import com.mungwin.agricothy.mails.MailClient;
...
public class UserServiceImpl implements UserService {
  ...
  private void sendActivationEmail(User user) {
    ...
    List<MailCtxDto> mailCtxDtos = new ArrayList<>(Arrays.asList(
      new MailCtxDto("appName", "Impact Academia LLC"),
